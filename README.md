...
After the application is launched, you need to register a new user by clicking on `CREATE NEW ACCOUNT` with the appropriate credentials and access the application with the same  credentials in `LOGIN` page.
